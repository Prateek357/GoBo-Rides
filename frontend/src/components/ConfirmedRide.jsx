...
const ConfirmedRide = (props) => {
  return (
    <div>
      <h5 className='p-1 w-[93%] absolute top-0 text-center' onClick={() => props.setConfirmRidePanel(false)}><i className='text-3xl text-gray-600 ri-arrow-down-wide-line'></i></h5>
      ...
      <button onClick={()=>{props.setVehicleFound(true); props.setConfirmRidePanel(false)}} className='w-full font-semibold rounded-lg bg-black text-white py-2 mt-5'>Confirm</button>
      </div>
      </div>
  )
}
