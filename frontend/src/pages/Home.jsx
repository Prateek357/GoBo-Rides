...
const Home = () => {
  ...
  useGSAP(function(){
    if(panelOpen){
      gsap.to(panelRef.current, {height: '70%',padding:24,opacity:1, duration: 0.5})
  ...
  return (
    ...
    <div className='flex flex-col justify-end h-screen absolute top-0 w-full'>
      ...
      <form onSubmit={(e) => {submithandler(e)}}>
        <div className="line absolute left-10 h-16 w-1 top-[45%] bg-gray-700 rounded-full"></div>
        <input 
    ...
    <div ref={vehiclePanelRef} className='fixed z-10 bg-white translate-y-full bottom-0 p-3 px-3 py-10 pt-12 w-full'>
      <VehiclePanel setConfirmRidePanel={setConfirmRidePanel} setVehiclePanel={setVehiclePanel}/>
    </div>
    <div ref={confirmRidePanelRef} className='fixed z-10 bg-white translate-y-full bottom-0 p-3 px-3 py-6 pt-12 w-full'>
      <ConfirmedRide setConfirmRidePanel={setConfirmRidePanel} setVehicleFound={setVehicleFound}/>
    </div>
    <div ref={vehicleFoundRef} className='fixed z-10 bg-white translate-y-full bottom-0 p-3 px-3 py-6 pt-12 w-full'>
      <LookingForDriver setConfirmRidePanel={setConfirmRidePanel} setVehicleFound={setVehicleFound}/>
    </div>
    <div ref={waitingForDriverRef} className='fixed z-10 bg-white translate-y-full  bottom-0 p-3 px-3 py-6 pt-12 w-full'>
